...
class Firework:
    ...
    def create_brocade(self):
        # Brocade: Gold/silver with crackling effect
        colors = [(255, 215, 0), (255, 255, 255), (255, 223, 0)]  # Gold and silver
        ...
        for _ in range(num_particles):
            ...
            particle = Particle(self.x, self.y, vx, vy, color, life, trail_length=8, size=2)
